...
class TistorySkin extends RemoteController {
  ...
  async preview (settings) {
    ...
    formData.append('variableSettings', JSON.stringify(settings.variableSettings || stat.variableSettings))
    formData.append('skinSettings', JSON.stringify(settings.skinSettings || stat.skinSettings))
