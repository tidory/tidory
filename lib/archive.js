...
module.exports = class extends Client {
  ...
  upload (path) {
    ...
    return this._client.post('/manage/design/skin/addFile.json', formData, {
   ...
   */
  unlink (filename) {
    return this._client.delete('/manage/design/skin/deleteFile.json', {
      data: {
        filename: filename
      }
    })
   ...
   */
  uploaded () {
    return this._client.get('/manage/design/skin/add.json')
  }
  ...
  remove (skinname) {
    ...
    return this._client.post('/manage/design/skin/delete.json', formData, {
      headers: formData.getHeaders()
    })
  }
  ...
  save (skinname) {
    ...
    return this._client.post('/manage/design/skin/add.json', formData, {
      headers: formData.getHeaders()
    })
  }
   ...
   */
  archive () {
    return this._client.get('/manage/design/skin/archivelist.json')
  }
}
