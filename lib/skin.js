...
module.exports = class extends Client {
   ...
   */
  prepare () {
    return this._client.get('/manage/design/skin/html.json')
  }
   ...
   */
  settings () {
    return this._client.get('/manage/design/skin/current.json')
  }
   ...
   */
  config (settings) {
    return this._client.post('/manage/design/skin/settings.json', settings)
  }
  ...
  async change (html, css, isPreview) {
    const { data } = await this._client.post('/manage/design/skin/html.json', {
      html: html,
      css: css,
      isPreview: isPreview
    })

    return url.resolve(this._client.defaults.baseURL, data)
  }
  ...
  upload (path) {
    ...
    return this._client.post('/manage/design/skin/resource.json', formData, {
   ...
   */
  unlink (path) {
    return this._client.delete('/manage/design/skin/resource.json', {
      data: {
        filename: path
      }
    })
  ...
  set (skinname) {
    ...
    return this._client.post('/manage/design/skin/set.json', formData, {
      headers: formData.getHeaders()
    })
  }
  ...
  async preview (settings) {
    ...
    return this._client.post('/manage/previewSkin.php', formData, {
      headers: formData.getHeaders()
    })
  }
}
